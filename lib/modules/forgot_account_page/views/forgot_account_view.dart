...
class ForgotAccountView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: getAppBar(context, title: getForgotAccountAppBarTitle(context),
          onTap: () {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ParcelButton(
                    width: Width * 0.8,
                    onTap: () {
                      if (forgotAccountProvider.formKey.currentState!
                          .validate()) {
                        // Perform the account recovery process
                        final mobileNumber =
                            forgotAccountProvider.mobileNumberController.text;
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                                'Account recovery instructions sent to $mobileNumber'),
                          ),
                        );
                      }
                    },
